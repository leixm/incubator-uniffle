...
3. update RSS_HOME/conf/server.conf, eg,
   ```
     ...
     rss.server.flush.local-file.threadPool.size 10
     rss.server.flush.hdfs.threadPool.size 10
...
| rss.server.flush.local-file.threadPool.size           | 10      | Thread pool for flush data to local file                                                                                                                                                                                                                                                                                                                                                 |
| rss.server.flush.hdfs.threadPool.size                 | 10      | Thread pool for flush data to hdfs                                                                                                                                                                                                                                                                                                                                                       |
...
Finally, to improve the speed of writing to HDFS for a single partition, the value of `rss.server.max.concurrency.of.single.partition.writer` and `rss.server.flush.hdfs.threadPool.size` could be increased to 10 or 20.
...
# For huge partitions
rss.server.flush.local-file.threadPool.size 20
rss.server.flush.hdfs.threadPool.size 20
